        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${
                errors.holderName ? "border-red-500" : "border-gray-300 focus:border-blue-500"
          ...
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${
                errors.nic ? "border-red-500" : "border-gray-300 focus:border-blue-500"
              } transition-all duration-200`}
            />
            {errors.nic && (
              <motion.p 
          ...
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${
                errors.policyNumber ? "border-red-500" : "border-gray-300 focus:border-blue-500"
              } transition-all duration-200`}
            />
            {errors.policyNumber && (
              <motion.p 
          ...
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${
                errors.sumAssured ? "border-red-500" : "border-gray-300 focus:border-blue-500"
              } transition-all duration-200`}
            />
            {errors.sumAssured && (
              <motion.p 
          ...
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${
                errors.premium ? "border-red-500" : "border-gray-300 focus:border-blue-500"
              } transition-all duration-200`}
            />
            {errors.premium && (
              <motion.p 
          ...
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 ${
                errors.lastPaidDate ? "border-red-500" : "border-gray-300 focus:border-blue-500"
              } transition-all duration-200`}
            />
            {errors.lastPaidDate && (
              <motion.p 
